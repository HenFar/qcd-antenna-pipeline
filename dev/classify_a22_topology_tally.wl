...
(* TallyComponent: Script-local helper for this development or benchmarking utility. *)
TallyComponent[component_] :=
  Module[{antenna, profile, basisLoad, reduction, rawReduced, records, coeffs,
      basis, term, mis, coeff, class},
    ...
    Print["=== ", component, " ==="];
    KeyValueMap[
      Print[#1, " -> ", InputForm[Together[#2] // Simplify]] &,
      KeySort[coeffs]
    ];
  ];

TallyComponent[Leading];
TallyComponent[Subleading];
TallyComponent[Nf];
