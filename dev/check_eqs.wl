...
Print["Leading equations:"];
Do[Print["  eps^", n, ": ", eqsL[[-n+1]] // FullSimplify], {n, -4, 0}];
Print["Subleading equations:"];
Do[Print["  eps^", n, ": ", eqsS[[-n+1]] // FullSimplify], {n, -4, 0}];

Print["\nSolving Leading equations only..."];
solL = Solve[eqsL, vars] // FullSimplify;
Print["Sol L: ", solL];

Print["\nSolving Subleading equations only..."];
solS = Solve[eqsS, vars] // FullSimplify;
Print["Sol S: ", solS];
