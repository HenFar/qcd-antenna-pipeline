...
cLA22LO = toSeries[Coefficient[bareL, A22LOMI]];
cLA3    = toSeries[Coefficient[bareL, A3MI]];
cLA4    = toSeries[Coefficient[bareL, A4MI]];
cLA6    = toSeries[Coefficient[bareL, A6MI]];

cSA22LO = toSeries[Coefficient[bareS, A22LOMI]];
cSA3    = toSeries[Coefficient[bareS, A3MI]];
cSA4    = toSeries[Coefficient[bareS, A4MI]];
cSA6    = toSeries[Coefficient[bareS, A6MI]];
...
intA21 = toSeries[IntegratedLowerAntenna[{A, 2, 1}, 2]];
...
If[Length[sol] > 0,
  ...
  Print["  x1new (A22LO at eps^1): ", x1new /. sol1 // FullSimplify];
  Print["  x2new (A22LO at eps^2): ", x2new /. sol1 // FullSimplify];
  Print["  y1 (A3   at 1/eps^1): ", y1 /. sol1 // FullSimplify];
  Print["  y0 (A3   at eps^0):   ", y0 /. sol1 // FullSimplify];
  Print["  y1new (A3   at eps^1): ", y1new /. sol1 // FullSimplify];
  Print["  y2new (A3   at eps^2): ", y2new /. sol1 // FullSimplify];
  Print["  y3new (A3   at eps^3): ", y3new /. sol1 // FullSimplify];
  ,
